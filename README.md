...
The custom Witch model docs are maintained under `witch_model/` and linked here for repository navigation:

- Folder: [witch_model/](./witch_model/)
- Detailed guide: [witch_model/README.md](./witch_model/README.md)
